...
import { fetchBalance as fetchBalanceFromApi } from "@/lib/client/apiClient";
...
/**
 * Hook for fetching and monitoring Stellar account balances.
 * Supports manual refresh and auto-refresh at configurable intervals.
 */
export function useBalance({
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      const info = await fetchBalanceFromApi(address);
